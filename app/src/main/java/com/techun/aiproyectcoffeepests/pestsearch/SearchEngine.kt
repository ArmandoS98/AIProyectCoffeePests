...
package com.techun.aiproyectcoffeepests.pestsearch
...
//    private val searchRequestQueue: RequestQueue = Volley.newRequestQueue(context)
    ...
    fun search(
        ...
        //AESC Implement our API Request
        ...
        /*Tasks.call<JsonObjectRequest>(requestCreationExecutor, Callable { createRequest(detectedObject) })
            .addOnSuccessListener { productRequest -> searchRequestQueue.add(productRequest.setTag(
                TAG
            )) }
